...
public class TachePonctuelleTest {
	...
	public void setUp() throws Exception {
		...
		tache = new TachePonctuelle("nomTache", "description", date, cat);
	}
	...
	public void testTachePonctuelleIntStringCalendar() throws ExceptionTacheAnterieur {
		Calendar date = new GregorianCalendar(2000,0,1);
		TachePonctuelle tp = new TachePonctuelle(1, "test", date);
	}
	...
	public void testEqualsTache() throws ExceptionTacheAnterieur {
		Calendar newDate = new GregorianCalendar(2018,7,13);
		Categorie newCat = new Categorie("newCat");
		TachePonctuelle tp = new TachePonctuelle("newTache", "newDescription", newDate, newCat);
